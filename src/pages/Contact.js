        ...
        <section className="contact-section">
          <div className="map-form-container">
            <div className="map-container">
              <h2 className="text-bold">Où Nous Trouver ?</h2>
              <iframe
                title="Map"
            ...
            <div className="form-container">
              <form
                ...
                method="POST"
                action="https://formspree.io/f/xeqwwlgy"
              >
                ...
                <div className="form-group form-check">
                  ...
                  <label className="form-check-label" htmlFor="privacy">
                    En envoyant mes informations, j'accepte votre Politique de
                    confidentialité
                  </label>
                </div>
          ...
          <div className="contact-info">
            <div className="contact-details">
              <h2>Coordonnées</h2>
              <p>
                Appart 9 Imm A Boujdour
                <br />
                Résidence Assabah CYM
                <br />
                Maroc
              </p>
            </div>
            <div className="contact-details">
              <h2>Contact</h2>
              <p>
                Tél : +212 6 68 280 801
                <br />
                Email : contact@oodi-info.com
              </p>
            </div>
          </div>
        </section>
