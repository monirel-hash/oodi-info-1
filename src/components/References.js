    ...
    <div className="container">
        ...
        <div className="row">
          <div className="col-md-6 mb-4">
            ...
            <ul>
              <img src="https://www.oodi-info.com/_media/img/small/pice025.tmp.jpg" alt="Solution 1" className="img-fluid mb-4" />
          ...
          <div className="col-md-6 mb-4">
            ...
            <ul>
              <img src="https://www.oodi-info.com/_media/img/small/pic63ca.tmp.jpg" alt="Solution 2" className="img-fluid mb-4" />
              <li>Solution de sauvegarde & réplication Veeam</li>
            </ul>
          </div>
        </div>
        <div className="row">
          <div className="col-md-6 mb-4">
            ...
            <ul>
              <img src="https://www.oodi-info.com/_media/img/small/pic9ec1.tmp.jpg" alt="Solution 3" className="img-fluid mb-4" />
